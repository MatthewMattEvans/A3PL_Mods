////////////////////////////////////////////////////////////////////
//DeRap: EC_DodgeRam\config.bin
//Produced from mikero's Dos Tools Dll version 10.10
//https://mikero.bytex.digital/Downloads
//'now' is Mon Feb 09 02:23:54 2026 : 'file' last modified on Thu Nov 13 10:25:40 2025
////////////////////////////////////////////////////////////////////
...
class CfgPatches
{
	class EC_DodgeRam
	{
		units[] = {"EC_DodgeRam","EC_DodgeRam_Lowered","EC_DodgeRam_PD","EC_DodgeRam_PD_ST","EC_DodgeRam_FD"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class EC_DodgeRam: Car_F
	{
		...
		displayName = "2017 Dodge Ram Lifted";
		...
		cargoAction[] = {"EC_DodgeRam_Passenger","EC_DodgeRam_Passenger","EC_DodgeRam_Passenger","EC_DodgeRam_Passenger"};
		...
		soundEngineOnInt[] = {"EC_Cars\EC_DodgeRam\sounds\int_start.wav",1.0206842,1};
		soundEngineOnExt[] = {"EC_Cars\EC_DodgeRam\sounds\ext_start.wav",1.0206842,1};
		soundEngineOffInt[] = {"EC_Cars\EC_DodgeRam\sounds\int_stop.wav",1.0206842,1};
		soundEngineOffExt[] = {"EC_Cars\EC_DodgeRam\sounds\ext_stop.wav",1.0206842,1};
		...
		class Sounds
		{
			class Idle_ext
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_idle.wav",0.22387211,1,150};
			...
			class Engine
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_1000.wav",0.2818383,1,200};
			...
			class Engine1_ext
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_2000.wav",0.3548134,1,240};
			...
			class Engine2_ext
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_3000.wav",0.39810717,1,280};
			...
			class Engine3_ext
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_4000.wav",0.4466836,1,320};
			...
			class Engine4_ext
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_5000.wav",0.5011872,1,360};
			...
			class Engine5_ext
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_6000.wav",0.56234133,1,420};
				frequency = "0.95 + ((rpm/ 6900) factor[(5100/ 6900),(6900/ 6900)])*0.15";
				volume = "engineOn*camPos*((rpm/ 6900) factor[(5100/ 6900),(6100/ 6900)])";
			};
			class Engine6_ext
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_7000.wav",0.63095737,1,420};
				frequency = "0.95 + ((rpm/ 6900) factor[(5100/ 6900),(6900/ 6900)])*0.15";
				volume = "engineOn*camPos*((rpm/ 6900) factor[(5100/ 6900),(6100/ 6900)])";
			};
			class IdleThrust
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_1000.wav",0.5011872,1,200};
				frequency = "0.9 + ((rpm/ 6900) factor[(400/ 6900),(1150/ 6900)])*0.2";
				volume = "engineOn*camPos*(0.4+(0.6*(thrust factor[0.1,1])))*(((rpm/ 6900) factor[(400/ 6900),(700/ 6900)]) * ((rpm/ 6900) factor[(1100/ 6900),(900/ 6900)]))";
			};
			class EngineThrust
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_2000.wav",0.56234133,1,250};
				frequency = "0.8 + ((rpm/ 6900) factor[(900/ 6900),(2100/ 6900)])*0.2";
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_3000.wav",0.63095737,1,280};
				frequency = "0.8 +  ((rpm/ 6900) factor[(1300/ 6900),(3100/ 6900)])*0.2";
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_4000.wav",0.70794576,1,320};
				frequency = "0.8 + ((rpm/ 6900) factor[(2200/ 6900),(4100/ 6900)])*0.2";
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_5000.wav",0.7943282,1,360};
				frequency = "0.8 + ((rpm/ 6900) factor[(3300/ 6900),(4900/ 6900)])*0.2";
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_6000.wav",1,1,400};
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\ext_7000.wav",1.2589254,1,450};
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\int_1000.wav",0.3548134,1};
				frequency = "0.8 + ((rpm/ 6900) factor[(900/ 6900),(2100/ 6900)])*0.2";
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\int_2000.wav",0.39810717,1};
				frequency = "0.8 +  ((rpm/ 6900) factor[(1300/ 6900),(3100/ 6900)])*0.2";
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\int_3000.wav",0.4466836,1};
				frequency = "0.8 + ((rpm/ 6900) factor[(2200/ 6900),(4100/ 6900)])*0.2";
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\int_4000.wav",0.5011872,1};
				frequency = "0.8 + ((rpm/ 6900) factor[(3300/ 6900),(4900/ 6900)])*0.2";
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\int_5000.wav",0.56234133,1};
				frequency = "0.8 + ((rpm/ 6900) factor[(4200/ 6900),(6200/ 6900)])*0.3";
			...
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\int_6000.wav",0.63095737,1};
				frequency = "0.9 + ((rpm/ 6900) factor[(5100/ 6900),(6900/ 6900)])*0.2";
				volume = "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*((rpm/ 6900) factor[(5100/ 6900),(6100/ 6900)])";
			};
			class Engine6_Thrust_int
			{
				sound[] = {"EC_Cars\EC_DodgeRam\sounds\int_7000.wav",0.63095737,1};
				frequency = "0.9 + ((rpm/ 6900) factor[(5100/ 6900),(6900/ 6900)])*0.2";
				volume = "engineOn*(1-camPos)*(0.4+(0.6*(thrust factor[0.1,1])))*((rpm/ 6900) factor[(5100/ 6900),(6100/ 6900)])";
			};
			class Movement
		...
		{
			GearboxRatios[] = {"R1",-0.1,"N",0,"D1",3.76,"D2",2.03,"D3",1.46,"D4",1.08,"D5",0.88,"D6",0.74};
			TransmissionRatios[] = {"High",3.42};
			gearBoxMode = "auto";
			moveOffGear = 1;
			driveString = "D";
			neutralString = "N";
		...
		torqueCurve[] = {{0,0},{0.14,0.51},{0.29,0.83},{0.43,0.89},{0.57,0.96},{0.71,0.98},{0.86,0.97},{1,0.77}};
		changeGearMinEffectivity[] = {0.95,0.15,0.9,0.87,0.87,0.87,0.87,0.87,0.87};
		switchTime = 0.11;
		latency = 1;
		class Wheels
		{
	...
	class EC_DodgeRam_Lowered: EC_DodgeRam
	{
		scope = 2;
		model = "\EC_Cars\EC_DodgeRam\EC_DodgeRam_Lowered";
		author = "EL COLOMBIA V12 / EC Marshall";
	...
	class EC_DodgeRam_PD: EC_DodgeRam
	{
		model = "EC_Cars\EC_DodgeRam\EC_DodgeRam_PD";
	...
	class EC_DodgeRam_PD_ST: EC_DodgeRam
	{
		model = "EC_Cars\EC_DodgeRam\EC_DodgeRam_PD_ST";
		hiddenSelections[] = {"Body","Lett_1","Lett_2","Lett_3","num_1","num_2","num_3","num_4","spd1","spd2","spd3","spd4","spd5","spd6","spd7","spd8","spd9","glass1","glass2","glass3","glass4","glass5","glass6"};
		hiddenSelectionsTextures[] = {"#(argb,8,8,3)color(0,0,0,1.0,co)","","","","","","","","a3pl_cars\common\textures\numbers\0.paa","a3pl_cars\common\textures\numbers\0.paa","a3pl_cars\common\textures\numbers\0.paa","a3pl_cars\common\textures\numbers\0.paa","a3pl_cars\common\textures\numbers\0.paa","a3pl_cars\common\textures\numbers\0.paa","a3pl_cars\common\textures\numbers\0.paa","a3pl_cars\common\textures\numbers\0.paa","a3pl_cars\common\textures\numbers\0.paa","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)"};
		displayName = "2017 Dodge Ram PD ST";
		class AnimationSources: AnimationSources
		{
			class Common
			{
	...
	class EC_DodgeRam_FD: EC_DodgeRam_PD
	{
		displayName = "2017 Dodge Ram FIFR";
		model = "EC_Cars\EC_DodgeRam\EC_DodgeRam_FD";
		class Reflectors: Reflectors
		{
			class LightCarHeadL01: LightCarHeadL01{};
			class LightCarHeadR01: LightCarHeadR01{};

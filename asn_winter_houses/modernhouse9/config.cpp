class CfgPatches {
	class asn_modernhouse9 {
		units[] = {"asn_modernhouse9"};
		weapons[] = {};
		magazines[] = {};
		ammo[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles {
	...
	class asn_modernhouse9 : House_F {
		model = "\asn_winter_houses\modernhouse9\9";
		scope = 2;
		displayName = "Modern House 4";
		...
		class AnimationSources {
			...
			class door_18 : door_02 {};
			class door_19 : door_02 {};
		};
		class UserActions {
			class Open_door_1 {

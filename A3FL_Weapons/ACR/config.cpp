...
class CfgWeapons {
	...
	class A3FL_ACR: arifle_MX_Base_F
	{
		...
		changeFiremodeSound[]= {"\A3FL_Weapons\ACR\sounds\selector.wss",1.5,1,5};
		drySound[]= {"\A3FL_Weapons\ACR\sounds\dryfire.wss",1.5,1,20};
		reloadMagazineSound[]= {"\A3FL_Weapons\ACR\sounds\reload.wss",2,1,10};
		...
		class Single: Mode_SemiAuto
		{
			...
			class StandardSound
			{
				begin1[]={"\A3FL_Weapons\ACR\sounds\fire.wss",1.1,1.2,1200};
				soundBegin[]={"begin1",1};
				class SoundTails
				{
					class TailTrees
		...
		class FullAuto: Mode_FullAuto
		{
			...
			class StandardSound
			{
				begin1[]={"\A3FL_Weapons\ACR\sounds\fire.wss",1.1,1.2,800};
				soundBegin[]={"begin1",1};
				class SoundTails
				{
					class TailTrees
					{
						sound[]={"A3\Sounds_F\arsenal\weapons\Rifles\Mk20\Mk20_tail_trees",1,1,800};
						frequency=1;
						volume="(1-interior/1.4)*trees";
					};
					class TailForest
					{
						sound[]={"A3\Sounds_F\arsenal\weapons\Rifles\Mk20\Mk20_tail_forest",1,1,800};
						frequency=1;
						volume="(1-interior/1.4)*forest";
					};
					class TailInterior
					{
						sound[]={"A3\Sounds_F\arsenal\weapons\Rifles\Mk20\Mk20_tail_interior",1.5848932,1,800};
						frequency=1;
						volume="interior";
					};
					class TailMeadows
					{
						sound[]={"A3\Sounds_F\arsenal\weapons\Rifles\Mk20\Mk20_tail_meadows",1,1,800};
						frequency=1;
						volume="(1-interior/1.4)*(meadows/2 max sea/2)";
					};
					class TailHouses
					{
						sound[]={"A3\Sounds_F\arsenal\weapons\Rifles\Mk20\Mk20_tail_houses",1,1,800};
						frequency=1;
						volume="(1-interior/1.4)*houses";
					};
				};

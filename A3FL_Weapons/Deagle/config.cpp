class CfgPatches
{
	...
	{
		units[] = {};
		weapons[] = {"A3FL_DesertEagle","A3FL_DesertEagleGold"};
		requiredVersion = 0.1;
		requiredAddons[] = {"A3_Weapons_F"};
		magazines[] = {"A3FL_DesertEagle_Mag"};
...
class cfgRecoils
{
	A3FL_DesertEagle[]={0,0,0, 0.500000,0,0.080000, 0.400000,0,0};
};
...
class CfgWeapons
{
	...
	class A3FL_DesertEagle: Pistol_Base_F
	{
		...
		drySound[]={"A3\Sounds_F\weapons\pistol_heavy_02\dry",0.69999999,1,20};
		reloadMagazineSound[]={"\A3FL_Weapons\Deagle\sounds\reload",1,1,10};
		modes[]={"Single"};
		class Single: Mode_SemiAuto
		{
			...
			class StandardSound
			{
				begin1[]={"\A3FL_Weapons\Deagle\sounds\fire",1,1,400};
				soundBegin[]={"begin1",1};	
				class SoundTails
				{
					class TailInterior
	...
	class A3FL_DesertEagleGold : A3FL_DesertEagle {
		...
		hiddenSelectionsMaterials[]={"\A3FL_Weapons\Deagle\data\golden_deagle.rvmat"};
	};
};
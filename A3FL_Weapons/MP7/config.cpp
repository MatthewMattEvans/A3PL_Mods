...
class CfgWeapons {
	...
	class A3FL_MP7: Rifle_Short_Base_F
	{
		...
		scope=2;
		magazines[]={"A3FL_MP7_Mag","A3FL_MP7_T_Mag"};
		maxZeroing=150;
...
class CfgMagazines
{
	...
	class A3FL_MP7_T_Mag: 16Rnd_9x21_Mag
	{
		displayName = "40Rnd Training MP7 Mag";
		author="Projets Opacity";
		scope= 2;
		type = 16;
		ammo = "A3FL_MP7_T_Ammo";
		count = 40;
		initSpeed = 280;
		mass = 6;
		descriptionShort="Caliber: 4.6x30mm<br/>Rounds: 40<br/>Used in: HK MP7";
...
class CfgAmmo
{
	...
	class A3FL_MP7_T_Ammo: BulletBase
	{
		hit=11;
		indirectHit=0;
		indirectHitRange=0;

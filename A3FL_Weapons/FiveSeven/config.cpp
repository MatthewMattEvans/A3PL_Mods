...
class CfgPatches
{
	...
	{
		units[] = {};
		weapons[] = {"A3FL_FiveSeven","A3FL_FiveSeven_Black","A3FL_FiveSeven_Pink"};
		requiredVersion = 0.1;
...
class cfgRecoils
{
	A3FL_FiveSeven_Recoil[] = {0,0.007,0.05,0.005,0.007,0.05,0.09,0,-0.01,0.1,0,0};
};

	...
	class A3FL_Glock17S: Pistol_Base_F
	{
		...
		class WeaponSlotsInfo: WeaponSlotsInfo
		{
			...
			class CowsSlot: CowsSlot_Pistol
			{
				...
				compatibleItems[] = {"optic_MRD_black","optic_MRD","optic_RMR"};
			};
...
class cfgRecoils
{
	A3FL_Glock18_Recoil[] = {0,0.007,0.05,0.005,0.007,0.05,0.09,0,-0.01,0.1,0,0};
	A3FL_Glock18Auto_Recoil[] = {0,0.007,0.02,0.005,0.007,0.02,0.09,0,-0.0014000001,0.1,0,0};
};

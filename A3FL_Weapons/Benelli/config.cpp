...
class CfgWeapons
{
	...
	class A3FL_Benelli: sgun_HunterShotgun_01_base_F
	{
		...
		magazines[]={"A3FL_Benelli_Buck","A3FL_Benelli_Slug","A3FL_Benelli_T_Mag"};
		magazineWell[]={};
		...
		class WeaponSlotsInfo: WeaponSlotsInfo
		{
			...
			class CowsSlot: CowsSlot
			{
				...
				iconScale=0.2;
				compatibleItems[]={"optic_ACO_grn","optic_ACO_grn_smg","optic_ACO_smg","optic_Holosight_smg_blk_F"};
			};
			class MuzzleSlot {};
			mass=80;
		};
...
class CfgAmmo
{
	...
	class A3FL_Benelli_T_Ammo: B_12Gauge_Slug
	{
		indirectHitRange = 10;
		initSpeed = 260;
		airFriction = -0.045;
...
class CfgMagazines
{
	...
	class A3FL_Benelli_T_Mag: 2Rnd_12Gauge_Slug
	{
		dlc="";
		author="Projets Opacity";
		displayName="Benelli Training Mag";
		displayNameShort="Slug";
		descriptionShort="Caliber: 12 Gauge (Slug)<br/>Rounds: 8<br/>Used in: Benelli M4";
		ammo="A3FL_Benelli_T_Ammo";
		count=8;
		initSpeed=210;
	};
};
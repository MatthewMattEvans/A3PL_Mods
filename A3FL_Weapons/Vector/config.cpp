...
class CfgWeapons {
	...
	class A3FL_Vector: Rifle_Short_Base_F
	{
		author="A3FL Winston";
		_generalMacro="A3FL_Vector";
		scope=2;
		magazines[]={"A3FL_Vector_Mag"};
		maxZeroing=150;
		...
		model="\A3FL_Weapons\Vector\A3FL_Vector";
		handAnim[]= {"OFP2_ManSkeleton","\A3\Weapons_F_beta\Smgs\SMG_01\data\Anim\SMG_01.rtm"};
		picture	= "\A3FL_Weapons\Vector\Vector.paa";
		Icon = "\A3FL_Weapons\Vector\Vector.paa";
		...
		class Single: Mode_SemiAuto
		{
			...
			{
				begin1[]= {"\A3FL_Weapons\Vector\data\fire.wss",0.85,1.2,1200};
				soundBegin[]= {"begin1",1};
				class SoundTails
				{
					class TailInterior
...
class CfgMagazines
{
	...
	class A3FL_Vector_Mag: 16Rnd_9x21_Mag
	{
		displayName = "26Rnd .45 Vector Mag";
		author="A3FL Winston";
		scope= 2;
		type = 16;
		ammo = "A3FL_Vector_Ammo";
		count = 26;
		initSpeed = 280;
		mass = 6;
		descriptionShort="Caliber: .45<br/>Rounds: 26<br/>Used in: Kriss Vector";
	};
};
...
{
	class BulletBase;
	class A3FL_Vector_Ammo: BulletBase
	{
		hit=10;
		indirectHit=0;
		indirectHitRange=0;

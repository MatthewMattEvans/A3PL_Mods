class CfgPatches
{
	...
	{
		units[] = {};
		weapons[] = {"A3FL_Glock17","A3FL_Glock17_T","A3FL_Glock17_MRD","A3FL_Glock17_Tan"};
		requiredVersion = 0.1;
		requiredAddons[] = {"A3_Weapons_F"};
		magazines[] = {"A3FL_Glock17_Mag","A3FL_Glock17_T_Mag"};
	...
	class A3FL_Glock17: Pistol_Base_F
	{
		...
		class WeaponSlotsInfo: WeaponSlotsInfo
		{
			...
			class CowsSlot: CowsSlot_Pistol
			{
				...
				compatibleItems[] = {"optic_MRD","optic_MRD_black","optic_RMR"};
			};
			class PointerSlot: PointerSlot
			{
				linkProxy = "\A3\data_f\proxies\weapon_slots\SIDE";
				compatibleItems[] = {"acc_flashlight_pistol","flashlight_X300"};
...
class cfgRecoils
{
	A3FL_Glock17_Recoil[] = {0,0.007,0.05,0.005,0.007,0.05,0.09,0,-0.01,0.1,0,0};
};

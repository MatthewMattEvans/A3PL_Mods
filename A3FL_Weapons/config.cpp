class CfgPatches
{
	class A3FL_Weapons
	{
		...
		units[]={};
		weapons[]={"A3FL_RifleBase","A3FL_PistolBase","MeleePistol","MeleeRifle","A3FL_BaseballBat","A3FL_GolfDriver","A3FL_PoliceBaton","A3FL_DickStick","A3FL_DickStickGold","A3FL_Crowbar"};
...
class CfgWeapons
{
	...
	class A3FL_DickStickGold: A3FL_DickStick
	{
		scope=2;
        Author="Andrew Axel";
		model="\A3FL_Weapons\Melee\A3FL_DickStickGold";
		displayName="Gold Dick Stick";
		class Library
		{
			libTextDesc="Gold Dick Stick";
		};
		descriptionShort="Gold Dick Stick";
	};

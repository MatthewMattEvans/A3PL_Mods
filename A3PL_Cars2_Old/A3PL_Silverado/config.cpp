...
class CfgVehicles 
{
    ...
    class A3PL_Silverado_PD: A3PL_Silverado 
	{
        ...
        class AnimationSources: AnimationSources 
		{
            ...
            class Spotlight_Addon: Mods
			{
				initPhase=1;
				displayName="Spotlight";
			};
			class Spotlight_Rotate {
				source = "user";
				animPeriod = 0.001;
				initPhase = 0;
			};
    ...
    class A3PL_Silverado_PD_ST: A3PL_Silverado_PD {
        displayName="2010 Chevrolet Silverado PD ST";
    ...
    class A3PL_Silverado_FD: A3PL_Silverado {
        ...
        hiddenSelections[] = {"Body","Lett_1","Lett_2","Lett_3","num_1","num_2","num_3","num_4"};
        hiddenSelectionsTextures[] = {"A3PL_Cars2\A3PL_Silverado\data\FIFR_Silverado_White.paa","","","","","","",""};
        class AnimationSources: AnimationSources {
            class Pushbar_Addon: Bed_Cover {
                initPhase = 1;
                displayName = "Pushbar";
    ...
    class A3PL_Silverado_FD_Brush: A3PL_Silverado_FD {
        ...
        hiddenSelections[] = {"Body","Lett_1","Lett_2","Lett_3","num_1","num_2","num_3","num_4","ft_num_1"};
        hiddenSelectionsTextures[] = {"A3PL_Cars2\A3PL_Silverado\data\Brush_tex\FIFR_SilveradoBrush.paa","","","","","","","",""};
        class AnimationSources: AnimationSources {
            class Pushbar_Addon {
                initPhase = 1;
                displayName = "Pushbar";

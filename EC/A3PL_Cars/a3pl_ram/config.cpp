...
class CfgVehicles
{
	...
	class A3PL_Ram: A3PL_Car_Base
	{
		scope=2;
		scopeCurator=2;
		scopeArsenal=2;
		displayName = "2011 Dodge Ram";
		class Library { libTextDesc = "2011 Dodge Ram"; };
		...
		fuelCapacity = 13;///mpg (imp.), average combined
		transportSoldier = 1;
		differentialType = "all_limited";
		model = "\A3PL_Cars\A3PL_Ram\A3PL_Ram";
		maxSpeed = 230;
		enginePower = 290;
		peakTorque = 650;
		terrainCoef = 3;
		...
		class AnimationSources: AnimationSources
		{
			...
			class Roof_Lights: Mods {displayName = "Roof Lights";forceAnimate[] = {"Roll_Bar",1};};
		...
		class Reflectors: Reflectors
		{
			...
			class Addon_1_Spotlight1: Addon_2_Spotlight1
			{
			...
			class Addon_1_Spotlight3: Addon_1_Spotlight1
			{
				position = "SpotlightL05";
				direction = "SpotlightL05_end";
			};
			class Addon_1_Spotlight4: Addon_1_Spotlight1
			{
				position = "SpotlightL06";
				direction = "SpotlightL06_end";
			};
			class Addon_1_Spotlight5: Addon_1_Spotlight1
			{
				position = "SpotlightR03";
				direction = "SpotlightR03_end";
			};
			class Addon_1_Spotlight6: Addon_1_Spotlight1
			{
				position = "SpotlightR04";
				direction = "SpotlightR04_end";
			};
			class Addon_1_Spotlight7: Addon_1_Spotlight1
			{
				position = "SpotlightR05";
				direction = "SpotlightR05_end";
			};
			class Addon_4_Spotlight1: Addon_2_Spotlight1
			{
				selection = "Driving_Lights_emit";
				position = "SpotlightL07";
				direction = "SpotlightL07_end";
				hitpoint = "SpotlightL07";
			};
			class Addon_4_Spotlight2: Addon_2_Spotlight1
			{
				position = "SpotlightR07";
				direction = "SpotlightR07_end";
				hitpoint = "SpotlightR07";
			};
		};
		aggregateReflectors[] = {{"Addon_2_Spotlight1","Addon_2_Spotlight2","Addon_2_Spotlight3","Addon_2_Spotlight4"},{"Addon_1_Spotlight1","Addon_1_Spotlight2","Addon_1_Spotlight3","Addon_1_Spotlight4","Addon_1_Spotlight5","Addon_1_Spotlight6","Addon_1_Spotlight7"},{"Addon_4_Spotlight1","Addon_4_Spotlight2"},{"LightCarHeadL01","LightCarHeadR01"},{"LightCarHeadL02","LightCarHeadR02"}};
		class Sounds: Sounds
		{
			...
			class	Idle_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\idle.wav", db-13,	1, 150};
			frequency	=	0.9	+	HZ_IDLE*0.2;
			volume = engineOn*camPos*VOLUME_IDLE;
			};
			class	Engine
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\1000.wav",	db-11,1, 200};
			frequency	=	0.8	+	HZ_RPM1*0.2;
			volume = engineOn*camPos*VOLUME_RPM1;
			};
			class	Engine1_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\2000.wav",	db-9,1, 240};
			frequency	=	0.8	+	HZ_RPM2*0.2;
			volume = engineOn*camPos*VOLUME_RPM2;
			};
			class	Engine2_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\3000.wav",	db-8,1, 280};
			frequency	=	0.8	+	HZ_RPM3*0.2;
			volume = engineOn*camPos*VOLUME_RPM3;
			};
			class	Engine3_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\4000.wav",	db-7,1, 320};
			frequency	=	0.8	+	HZ_RPM4*0.2;
			volume = engineOn*camPos*VOLUME_RPM4;
			};
			class	Engine4_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\5000.wav",	db-6,1, 360};
			frequency	=	0.8	+	HZ_RPM5*0.2;
			volume = engineOn*camPos*VOLUME_RPM5;
			};
			class	Engine5_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\6000.wav",	db-5,1, 420};
			frequency	=	0.95	+	HZ_RPM6*0.15;
			volume = engineOn*camPos*VOLUME_RPM6;
			};
			class	Engine6_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\7000.wav", db-13,	1, 150};
			frequency	=	0.9	+	HZ_RPM7*0.2;
			volume = engineOn*camPos*VOLUME_RPM7;
			};
			class	Engine7_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\8000.wav",	db-11,1, 200};
			frequency	=	0.8	+	HZ_RPM8*0.2;
			volume = engineOn*camPos*VOLUME_RPM8;
			};
			class	Engine8_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\9000.wav",	db-9,1, 240};
			frequency	=	0.8	+	HZ_RPM9*0.2;
			volume = engineOn*camPos*VOLUME_RPM9;
			};
			class	Engine9_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\10000.wav",	db-8,1, 280};
			frequency	=	0.8	+	HZ_RPM10*0.2;
			volume = engineOn*camPos*VOLUME_RPM10;
			};
			class	Engine10_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\11000.wav",	db-7,1, 320};
			frequency	=	0.8	+	HZ_RPM11*0.2;
			volume = engineOn*camPos*VOLUME_RPM11;
			};
			class	Engine11_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\12000.wav",	db-6,1, 360};
			frequency	=	0.8	+	HZ_RPM12*0.2;
			volume = engineOn*camPos*VOLUME_RPM12;
			};
			class	Engine12_ext
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\13000.wav",	db-5,1, 420};
			frequency	=	0.95	+	HZ_RPM13*0.15;
			volume = engineOn*camPos*VOLUME_RPM13;
			};
			class	Idle_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\Idle.wav", db-15,	1};
			frequency	=	0.9	+	HZ_IDLE*0.2;
			volume = engineOn*(1-camPos)*VOLUME_IDLE;
			};
			class	Engine_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\1000.wav",	db-14,1 };
			frequency	=	0.8	+	HZ_RPM1*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM1;
			};
			class	Engine1_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\2000.wav",	db-12,1 };
			frequency	=	0.8	+	HZ_RPM2*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM2;
			};
			class	Engine2_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\3000.wav",	db-11,1 };
			frequency	=	0.8	+	HZ_RPM3*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM3;
			};
			class	Engine3_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\4000.wav",	db-10,1 };
			frequency	=	0.8	+	HZ_RPM4*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM4;
			};
			class	Engine4_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\5000.wav",	db-9,1 };
			frequency	=	0.8	+	HZ_RPM5*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM5;
			};
			class	Engine5_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\6000.wav",	db-6,1 };
			frequency	=	0.95	+	HZ_RPM6*0.15;
			volume = engineOn*(1-camPos)*VOLUME_RPM6;
			};
			class	Engine6_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\7000.wav", db-15,	1};
			frequency	=	0.9	+	HZ_RPM7*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM7;
			};
			class	Engine7_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\8000.wav",	db-14,1 };
			frequency	=	0.8	+	HZ_RPM8*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM8;
			};
			class	Engine8_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\9000.wav",	db-12,1 };
			frequency	=	0.8	+	HZ_RPM9*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM9;
			};
			class	Engine9_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\10000.wav",	db-11,1 };
			frequency	=	0.8	+	HZ_RPM10*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM10;
			};
			class	Engine10_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\11000.wav",	db-10,1 };
			frequency	=	0.8	+	HZ_RPM11*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM11;
			};
			class	Engine11_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\12000.wav",	db-9,1 };
			frequency	=	0.8	+	HZ_RPM12*0.2;
			volume = engineOn*(1-camPos)*VOLUME_RPM12;
			};
			class	Engine12_int
			{
			sound[]	=	{"A3PL_Cars\A3PL_Ram\Sounds\13000.wav",	db-6,1 };
			frequency	=	0.95	+	HZ_RPM13*0.15;
    ...
    class A3PL_Ram_ML: A3PL_Ram
	{
		displayName = "2011 Dodge Ram MarkerLights";
		model = "\A3PL_Cars\A3PL_Ram\A3PL_Ram_ML";
		hiddenSelections[]={"Body","Lett_1","Lett_2","Lett_3","num_1","num_2","num_3","num_4","glass1","glass2","glass3","glass4","glass5","glass6"};
		hiddenSelectionsTextures[]={"#(argb,8,8,3)color(0,0,0,1.0,CO)","","","","","","","","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)","#(argb,8,8,3)color(0,0,0,0.8,ca)"};
		class AnimationSources: AnimationSources
		{

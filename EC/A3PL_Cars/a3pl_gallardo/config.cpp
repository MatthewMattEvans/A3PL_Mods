...
class CfgVehicles
{
	...
	class A3PL_Car_Base: Hatchback_01_sport_base_F {class Sounds;class Wheels;class AnimationSources{class Mods;};};
	class A3PL_Gallardo: A3PL_Car_Base
	{
		scope=2;
		scopeCurator=2;
		scopeArsenal=2;
		displayName = "Lamborghini Gallardo";
		class Library { libTextDesc = "Lamborghini Gallardo"; };
		...
		fuelCapacity = 15.2;///mpg (imp.), average combined
		transportSoldier = 1;
		differentialType = "all_open";
		model = "\A3PL_Cars\A3PL_Gallardo\A3PL_Gallardo";
		maxSpeed = 325;
		enginePower = 523;
		peakTorque = 510;
		...
		{
			class Spoiler1: Mods {displayName = "Spoiler";};
		};
		class Sounds: Sounds
		{

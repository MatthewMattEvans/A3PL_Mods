...
class CfgMovesBasic
{
	...
	class ManActions
	{
		A3FL_370Z_Driver="A3FL_370Z_Driver";
		A3FL_370Z_Passenger="A3FL_370Z_Passenger";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	class States
	{
		...
		class A3FL_370Z_Driver: Crew
		{
			file="\A3FL_Cars5\A3FL_370z\Anim\A3FL_370Z_Driver.rtm";
			interpolateTo[]=
			{
				"driver_lsv01_kia",
				1
		...
		class A3FL_370Z_Passenger: Crew
		{
			file="\A3FL_Cars5\A3FL_370z\Anim\A3FL_370Z_Passenger.rtm";
			interpolateTo[]=
			{
				"driver_lsv01_kia",
				1
...
class CfgVehicles
{
	...
	class A3FL_370Z: Car_F
	{
		scope=2;
		model="\A3FL_Cars5\A3FL_370z\A3FL_370z";
		picture="";
		weapons[]={"A3PL_CarHorn"};
		author="A3FL Winters & Winston & Marshall";
		displayName="2010 Nissan 370Z";
		extCameraPosition[]={0,1.1,-5};
		driveOnComponent[]=
		{
			"wheel_1_1_damper",
			"wheel_1_2_damper",
		...
		hiddenSelectionsTextures[]={"#(argb,8,8,3)color(0,0,0,1.0,CO)","","","","","","","","a3pl_cars\common\textures\glass.paa","a3pl_cars\common\textures\glass.paa","a3pl_cars\common\textures\glass.paa","a3pl_cars\common\textures\glass.paa","a3pl_cars\common\textures\glass.paa","a3pl_cars\common\textures\glass.paa"};
		insideSoundCoef=1;
		...
		waterResistance=1;
		crewCrashProtection=0.89999998;
		...
		thrustDelay=0.40000001;
		brakeIdleSpeed=1.78;
		maxSpeed=245;
		fuelCapacity=20;
		wheelCircumference=2.073;
		engineStartSpeed=1.2;
		idleRpm=1000;
		redRpm=6800;
		...
		class Wheels
		{
			class LF
			{
				...
				MaxDroop=0.1;
				sprungMass=384;
				springStrength=79594;
				springDamperRate=4423;

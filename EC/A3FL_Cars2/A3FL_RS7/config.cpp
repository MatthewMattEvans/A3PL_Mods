...
class CfgMovesBasic
{
	...
	class ManActions
	{
		A3FL_RS7_BackPassanger="A3FL_RS7_BackPassanger";
		A3FL_RS7_Passanger="A3FL_RS7_Passanger";
		A3FL_RS7_Driver="A3FL_RS7_Driver";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class A3FL_RS7_BackPassanger: Crew {
			file="\A3FL_Cars2\A3FL_RS7\anim\A3FL_RS7_BackPassanger.rtm";
		};
		class A3FL_RS7_Passanger: Crew {
			file="\A3FL_Cars2\A3FL_RS7\anim\A3FL_RS7_Passanger.rtm";
		};
		class A3FL_RS7_Driver: Crew {
			file="\A3FL_Cars2\A3FL_RS7\anim\A3FL_RS7_Driver.rtm";
		};
	};
};
class CfgVehicles
{
	...
	class A3FL_RS7: Car_F
	{
		scope=2;
		model="A3FL_Cars2\A3FL_RS7\A3FL_RS7";
		weapons[]={"A3PL_CarHorn"};
		displayName="2013 Audi RS7";
		author="A3FL Winters";
		...
		{
			turnIncreaseConst	= 3.6; // basic sensitivity value, higher value = faster steering
			turnIncreaseLinear	= 0.15; // higher value means less sensitive steering in higher speed, more sensitive in lower speeds
		...
		driverAction="A3FL_RS7_Driver";
		cargoAction[]=
		{
			"A3FL_RS7_Passanger",
			"A3FL_RS7_BackPassanger",
			"A3FL_RS7_BackPassanger"
		};
		...
		class Wheels
		{
			class LF
			{
				...
				longitudinalStiffnessPerUnitGravity=7900;
				latStiffX=25;
				latStiffY=220;
				frictionVsSlipGraph[]=
				{

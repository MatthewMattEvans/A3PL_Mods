...
class CfgMagazines {
	class CA_Magazine;
	class A3FL_M4_T_Mag: CA_Magazine
	{
		author="A3FL Winston";
		scope=2;
		type=16;
		model="\A3PL_Weapons2\M16\A3PL_M16_Mag";
		displayName="M4 Training Mag";
		displayNameShort="Training ammo";
		picture="\A3PL_Weapons2\M16\M16_Mag.paa";
		ammo="A3FL_M4_T_Ball";
		count=30;
		initSpeed=997;
		descriptionShort="Training ammo";
		mass=10;
		tracersEvery=0;
		lastRoundsTracer=0;
	};
...
{
	class B_556x45_Ball;
	class A3FL_M4_T_Ball: B_556x45_Ball
	{
...
class CfgWeapons {
	...
	class A3FL_M4: arifle_SPAR_01_base_F
	{
		...
		hiddenSelections[] = {"Barrel","foregrip","magazine","rail","Reciever","Stock"};
		hiddenSelectionsTextures[] = {"A3FL_Weapons\M4\data\Barrel\M4Barrel_Main.paa","A3FL_Weapons\M4\data\Foregrip\M4Foregrip_Main.paa","A3FL_Weapons\M4\data\Mag\M4Magazine_Main.paa","A3FL_Weapons\M4\data\Carryhandle\M4Carryhandle_Main.paa","A3FL_Weapons\M4\data\Receiver\M4Receiver_Main.paa","A3FL_Weapons\M4\data\Stock\M4Stock_Main.paa"};
		...
		class Single: Mode_SemiAuto
		{
			...
			class StandardSound
			{
				begin1[]={"\A3FL_Weapons\M4\sounds\M4New.wss",db+30,1.2,1200};
				soundBegin[]={"begin1",1};
				class SoundTails
				{
					class TailTrees
	...
	class A3FL_M4_Training: A3FL_M4
	{
		magazines[]= {"A3FL_M4_T_Mag"};
		author="A3FL Winston & Davis";
		_generalMacro="A3FL_M4";
		displayName="Colt M4A1 Training";
		descriptionShort="Colt M4A1 Training";
		hiddenSelectionsTextures[] = {"A3FL_Weapons\M4\data\Barrel\M4Barrel_MainT.paa","A3FL_Weapons\M4\data\Foregrip\M4Foregrip_MainT.paa","A3FL_Weapons\M4\data\Mag\M4Magazine_MainT.paa","A3FL_Weapons\M4\data\Carryhandle\M4Carryhandle_MainT.paa","A3FL_Weapons\M4\data\Receiver\M4Receiver_MainT.paa","A3FL_Weapons\M4\data\Stock\M4Stock_MainT.paa"};
	};
};
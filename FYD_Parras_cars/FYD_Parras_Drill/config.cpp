...
class CfgVehicles
{
	...
	class FYD_Parras_Drill: A3PL_Prime_Mover_Base
	{
		author="Valentin Parras";
		displayName="Peterbilt Drill Truck";
		class Library
		{
			libTextDesc="Peterbilt Drill Truck";
		};
		fuelCapacity=45;
		transportSoldier=1;
		differentialType="rear_open";
		model="\FYD_Parras_cars\FYD_Parras_Drill\FYD_Parras_Drill";

////////////////////////////////////////////////////////////////////
//DeRap: CompM5\config.bin
//Produced from mikero's Dos Tools Dll version 9.61
//https://mikero.bytex.digital/Downloads
//'now' is Mon Oct 07 21:43:56 2024 : 'file' last modified on Mon Oct 07 21:43:56 2024
////////////////////////////////////////////////////////////////////
...
class CfgPatches
{
	class EC_Optics_CompM5
	{
		addonRootClass = "EC_Optics";
		requiredAddons[] = {"A3_Weapons_F","A3_Weapons_F_Items"};
		requiredVersion = 0.1;
		units[] = {};
		weapons[] = {"optic_CompM5","Zasleh2","muzzle_snds_H","muzzle_snds_L","muzzle_snds_M","muzzle_snds_B","muzzle_snds_acp"};
	};
};
class Mode_SemiAuto;
class Mode_Burst;
...
class CfgWeapons
{
	...
	class optic_CompM5: ItemCore
	{
		author = "Davis Abrams";
		_generalMacro = "optic_CompM5";
		scope = 2;
		displayName = "Aimpoint CompM5 UM";
		picture = "\EC_Optics\CompM5\Data\ui\M5Unit.paa";
		Icon = "\EC_Optics\CompM5\Data\ui\M5Unit.paa";
		model = "EC_Optics\CompM5\CompM5.p3d";
		descriptionShort = "Aimpoint CompM5 With Unity Mount";

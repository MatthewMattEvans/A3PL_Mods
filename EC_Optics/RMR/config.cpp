...
class CfgPatches
{
	class EC_Optics_RMR
	{
		...
		requiredVersion = 0.1;
		units[] = {};
		weapons[] = {"optic_RMR","Zasleh2","muzzle_snds_H","muzzle_snds_L","muzzle_snds_M","muzzle_snds_B","muzzle_snds_acp"};
	};
};
class Mode_SemiAuto;
class Mode_Burst;
...
class CfgWeapons
{
	...
	class optic_RMR: ItemCore
	{
		author = "Davis Abrams";
		_generalMacro = "optic_RMR";
		scope = 2;
		displayName = "Trijicon RMR";
		picture = "\EC_Optics\RMR\Data\ui\trijrmr.paa";
		model = "EC_Optics\RMR\Trij_RMR.p3d";

...
class HDRNewPars {
	...
	tonemapLinearAngle = 0.105;
	tonemapToeStrength = 0.15000001;
	tonemapToeNumerator = 0.017000001;
	tonemapToeDenominator = 0.15000001;
	tonemapLinearWhite = 6.1999998;
	tonemapExposureBias = 0.94999999;
...
class Lighting : DefaultLighting {
	groundReflection[] = { 0.06, 0.06, 0.04 };

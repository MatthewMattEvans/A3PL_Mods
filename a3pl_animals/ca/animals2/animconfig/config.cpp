...
{
	author = "rwsender";
	timepacked = "1541361946";
};
class CfgPatches
{
	class A3PL_Animals_Anim_Config
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"A3PL_Animals"};
	};
};
class CfgMovesAnimal_Base_F;
class CfgMovesDog_F;
class CfgMovesAnimalsBase: CfgMovesAnimal_Base_F
{
	class Default
	{
		actions = "";
...
class CfgMovesCock: CfgMovesAnimalsBase
{
	...
	class States
	{
		class Cock_Stop: StandBase
		{
			...
			variantsAI[] = {"Cock_Run",0.1,"Cock_WalkWings",0.2,"Cock_Walk",0.2,"Cock_Wings",0.1,"Cock_Eat",0.4};
			actions = "CockActions";
...
class CfgMovesHen: CfgMovesAnimalsBase
{
	...
	class States
	{
		class Hen_Stop: StandBase
		{
			...
			variantsAI[] = {"Hen_Stop",0.1,"Hen_Run",0.3,"Hen_Walk",0.3,"Hen_Eat",0.2};
			variantsPlayer[] = {};
			variantAfter[] = {3,6,9};
			actions = "HenActions";
			speed = 1e+10;
...
class CfgMovesCow: CfgMovesAnimalsBase
{
	...
	class States
	{
		class Cow_Stop: StandBase
		{
			...
			variantsAI[] = {"Cow_postavani",0.3,"Cow_idle_postavaniRozhliziSe",0.2,"Cow_idle_postavaniSklaniSe",0.2,"Cow_Walk",0.2,"Cow_Run",0.1};
			variantAfter[] = {20,30,40};
			speed = 1e+10;
			relSpeedMin = 0.7;
			relSpeedMax = 1.1;
			looped = 1;
...
class CfgMovesDog: CfgMovesAnimalsBase
{
	...
	class States
	{
		class Dog_Stop: StandBase
		{
			...
			variantsAI[] = {"Dog_Sprint",0.1,"Dog_Run",0.2,"Dog_Walk",0.1,"Dog_Walk",0.1,"Dog_Sit1",0.1,"Dog_StopV2",0.1,"Dog_StopV1",0.1,"Dog_Siting",0.1,"Dog_Sit3",0.1};
			variantAfter[] = {0,2,3};
			speed = 1e+10;
			relSpeedMin = 0.7;
			relSpeedMax = 1.1;
...
class CfgMovesGoat: CfgMovesAnimalsBase
{
	...
	class States
	{
		class Goat_Stop: StandBase
		{
			...
			variantsAI[] = {"Goat_Sprint",0.2,"Goat_Walk",0.8};
			showWeaponAim = 0;
			disableWeapons = 1;
			disableWeaponsLong = 1;
			speed = 1e+10;
...
class CfgMovesSheep: CfgMovesAnimalsBase
{
	...
	class States
	{
		class Sheep_Stop: StandBase
		{
			...
			variantsAI[] = {"Sheep_Run",0.2,"Sheep_Walk",0.2,"Sheep_Eat",0.6};
...
class CfgMovesWildBoar: CfgMovesAnimalsBase
{
	...
	class States
	{
		class WildBoar_Stop: StandBase
		{
			...
			variantsAI[] = {"WildBoar_Eat",0.6,"WildBoar_Walk",0.2,"WildBoar_Run",0.2};
			variantAfter[] = {10,15,20};
			speed = 1e+10;
			soundEnabled = 0;

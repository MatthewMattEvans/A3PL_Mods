...
class CfgVehicles {
	...
	class A3PL_FD_HoseEnd1 : A3PL_Car_Base {
		...
		fuelCapacity = 16.8; /// mpg (imp.), average combined
		transportSoldier = 0;
		maxSpeed = 300;
		enginePower = 309;
		peakTorque = 400;
		wheelDestroyRadiusCoef = 0.82;
	...
	/*class A3PL_FD_HoseEnd1: Land_BuoyBig_F
	{
	_generalMacro = "A3PL_FD_HoseEnd1";
	maximumLoad = 0;
	memoryPointSupply = "";
	collisionEffect = "EmptyEffect";
	explosionEffect = "EmptyEffect";
	impactEffectsSea = "EmptyEffect";
	leftDustEffect = "EmptyEffect";
	rightDustEffect = "EmptyEffect";
	...
	WoodCrash0[] = {"",1.0,1,200};
	WoodCrash1[] = {"",1.0,1,200};
	WoodCrash2[] = {"",1.0,1,200};
	WoodCrash3[] = {"",1.0,1,200};
	WoodCrash4[] = {"",1.0,1,200};
	WoodCrash5[] = {"",1.0,1,200};
	hiddenSelections[] ={};
	picture = "\A3PL_Characters\A3PL_Logo.paa";
	scope = 1;
	};*/
	...
	class A3PL_Lifebuoy : A3PL_Ship_Base {
		...
		cargoAction[] = { "A3PL_Lifebuoy_Cargo" };
		cargoGetInAction[] = { "GetInHemttBack" };
		maxSpeed = 100;
		enginePower = 0;
		waterLeakiness = 0;
	...
	class A3PL_Container_Hook : A3PL_Objects {
		...
		slingLoadCargoMemoryPoints[] = { "Cable_1_End", "Cable_2_End", "Cable_3_End" };
	};
	...
	class A3PL_Container40 : A3PL_Objects {
		...
		class TextureSources {
			class Blue {
				...
				textures[] = { "\A3\Structures_F\Data\Metal\Containers\Containers_colors_01_co.paa" };
				factions[] = { "CIV_F" };
			};
			class Light_Blue {
				displayName = "Light Blue";
				author = "$STR_A3_Bohemia_Interactive";
				textures[] = { "\A3\Structures_F\Data\Metal\Containers\Containers_colors_05_co.paa" };
				factions[] = { "CIV_F" };
			};
			class Light_Green {
				displayName = "Light Green";
				author = "$STR_A3_Bohemia_Interactive";
				textures[] = { "\A3\Structures_F\Data\Metal\Containers\Containers_colors_04_co.paa" };
				factions[] = { "CIV_F" };
			};
			class Military_Green {
				displayName = "Military Green";
				author = "$STR_A3_Bohemia_Interactive";
				textures[] = { "\A3\Structures_F\Data\Metal\Containers\Containers_colors_02_co.paa" };
				factions[] = { "CIV_F" };
			};
			class Orange {
				displayName = "Orange";
				author = "$STR_A3_Bohemia_Interactive";
				textures[] = { "\A3\Structures_F\Data\Metal\Containers\Containers_colors_03_co.paa" };
				factions[] = { "CIV_F" };
			};
		};
		textureList[] = { "Blue", 1, "Light_Blue", 1, "Light_Green", 1, "Military_Green", 1, "Orange", 1 };
	};
	...
	class Land_A3PL_EstateSign : A3PL_Houses {
		...
		hiddenSelections[] = { "EstateSign" };
		hiddenSelectionsTextures[] = { "\A3PL_Objects\Street\estate_sign\house_sale_co.paa" };
	};
	class Land_A3PL_GreenhouseSign : A3PL_Houses {
		...
		hiddenSelections[] = { "GreenhouseSign" };
		hiddenSelectionsTextures[] = { "\A3PL_Objects\Street\rent_sign\Data\rent_sign_forrent_co.paa" };
	};
	...
	class Land_A3PL_BusinessSign : A3PL_Houses {
		...
		hiddenSelections[] = { "sign_business" };
		hiddenSelectionsTextures[] = { "\a3pl_objects\street\business_sign\business_sale_co.paa" };
	};
	...
	class A3PL_UniformStatic : A3PL_Objects {
		...
		hiddenSelections[] = { "camo" };
		hiddenSelectionsTextures[] = { "A3PL_Characters\Civ_Default\Alpha.paa" };
	};
	...
	class A3PL_Seed_Marijuana : A3PL_Objects {
		...
		hiddenSelections[] = { "seedBox" };
		hiddenSelectionsTextures[] = { "A3PL_Objects\farming\Data\seeds_co.paa" };
	};
	class A3PL_Seed_Corn : A3PL_Seed_Marijuana {
		_generalMacro = "A3PL_Seed_Corn";
		displayName = "Seed Corn";
		hiddenSelectionsTextures[] = { "A3PL_Objects\farming\Data\corn_seeds_co.paa" };
	};
	class A3PL_Seed_Wheat : A3PL_Seed_Marijuana {
		_generalMacro = "A3PL_Seed_Wheat";
		displayName = "Seed Wheat";
		hiddenSelectionsTextures[] = { "A3PL_Objects\farming\Data\wheat_seeds_co.paa" };
	};
	class A3PL_Seed_Lettuce : A3PL_Seed_Marijuana {
		_generalMacro = "A3PL_Seed_Lettuce";
		displayName = "Seed Lettuce";
		hiddenSelectionsTextures[] = { "A3PL_Objects\farming\Data\lettuce_seeds_co.paa" };
	};
	class A3PL_Seed_Coca : A3PL_Seed_Marijuana {
		_generalMacro = "A3PL_Seed_Coca";
		displayName = "Seed Lettuce";
		hiddenSelectionsTextures[] = {"A3PL_Objects\farming\Data\coca_seeds_co.paa"};
	};
	class A3PL_Seed_Sugarcane : A3PL_Seed_Marijuana {
		_generalMacro = "A3PL_Seed_Sugarcane";
		displayName = "Seed Lettuce";
		hiddenSelectionsTextures[] = {"A3PL_Objects\farming\Data\sugarcane_seeds_co.paa"};
	};
	class A3PL_Seed_Carrot : A3PL_Seed_Marijuana {
		_generalMacro = "A3PL_Seed_Carrot";
		displayName = "Seed Lettuce";
		hiddenSelectionsTextures[] = {"A3PL_Objects\farming\Data\carrot_seeds_co.paa"};
	};
	class A3PL_Seed_Tobacco : A3PL_Seed_Marijuana {
		_generalMacro = "A3PL_Seed_Tobacco";
		displayName = "Seed Lettuce";
		hiddenSelectionsTextures[] = {"A3PL_Objects\farming\Data\tobacco_seeds_co.paa"};
	};
	...
	class A3PL_Bucket : A3PL_Objects {
		...
		displayName = "Bucket";
		hiddenSelections[] = { "fish" };
		hiddenSelectionsTextures[] = { "" };
	};
	class A3PL_BucketFull : A3PL_Bucket {
		_generalMacro = "A3PL_BucketFull";
		hiddenSelectionsTextures[] = { "A3PL_Objects\fishing\Data\fishing_co.paa" };
	};
	...
	class A3PL_FD_HoseEnd1_Float : A3PL_FD_HoseEnd1 // this model does not have geometry so it floats
	{
		_generalMacro = "A3PL_FD_HoseEnd1";
	...
	class A3PL_FD_HoseEnd_Player : A3PL_Objects // Hose-End for player_item (more optimized than a vehicle)
	{
		_generalMacro = "A3PL_FD_HoseEnd_Player";
		model = "\A3PL_Objects\FD\A3PL_HoseEnd_Player";
		displayName = "Hose End -Player";
	};
	class A3PL_FD_EmptyPhysx : A3PL_Objects // Empty physx object
	{
	...
	class A3PL_FireObject : A3PL_Objects // FIRE OBJECT FOR FIRE SCRIPTS
	{
	...
	class A3PL_FD_Oxygen_Obj : A3PL_Objects // OBJECTS FROM A3PL_CHARACTERS
	{
	...
	class A3PL_PremiumOilBarrel : A3PL_Objects {
		vehicleclass = "A3PL_Objects";
		_generalMacro = "A3PL_PremiumOilBarrel";
		model = "\A3PL_Objects\oil\barrel\A3PL_PremiumOilBarrel.p3d";
		displayName = "Premium grade Oil Barrel";
	};
	...
	class A3PL_File2 : A3PL_Objects {
		...
		hiddenSelections[] = { "camo" };
		hiddenSelectionsTextures[] = { "\A3\Structures_F_EPC\Items\Documents\Data\Files_secret_CA.paa" };
	};
...
class CfgAnimationSourceSounds {
	class RocketFuse {
		class Fuse {
			...
			sound0[] = { "\A3PL_Objects\Small\Sounds\fuse.ogg", 1, 1, 50 };
			sound[] = { "sound0", 1 };
		};
		class FuseFinal {
			loop = 0;
			...
			sound0[] = { "\A3PL_Objects\Small\Sounds\rocketWhistle1.ogg", 1, 1, 100 };
			sound1[] = { "\A3PL_Objects\Small\Sounds\rocketWhistle2.ogg", 1, 1, 100 };

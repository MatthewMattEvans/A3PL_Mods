class CfgPatches
{
	class A3FL_T440_Cab_Chassis_Truck
	{
		units[]=
		{
...
class CfgVehicles
{
	...
	class A3FL_T440_Gas_Tanker: A3PL_Prime_Mover_Base
	{
		...
		displayName="Kenworth T440 Gas Tanker";
		class Library
		{
			libTextDesc="Kenworth T440 Gas Tanker";
		};
		fuelCapacity=45;
		transportSoldier=1;
		differentialType="rear_open";
		model="\A3FL_Cars\A3FL_T440_Cab_Chassis_Truck\A3FL_T440_Gas_Tanker";
	...
	class A3FL_T440_Water_Tanker: A3FL_T440_Gas_Tanker
	{
		author="Danny Indelicato & Henry Indelicato";
		displayName="Kenworth T440 Water Tanker";
		class Library
		{
			libTextDesc="Kenworth T440 Water Tanker";
		};
		model="\A3FL_Cars\A3FL_T440_Cab_Chassis_Truck\A3FL_T440_Water_Tanker";
		hiddenSelections[]={"Body","Lett_1","Lett_2","Lett_3","num_1","num_2","num_3","num_4","tank"};
		hiddenSelectionsTextures[]={"A3PL_Textures\Kenworth\FIFR_Cabin.paa","","","","","","","","A3PL_Textures\Kenworth\FIFR_Tanker.paa"};
		driverAction="A3FL_Kenworth_Anim";
		cargoAction[]=
		{
			"Truck_Cargo01"

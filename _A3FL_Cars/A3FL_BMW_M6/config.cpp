...
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	class States
	{
		...
		class A3FL_Driver1: driver_offroad01
		{
			file="\A3FL_Cars\common\anim\a3pl_driver1.rtm";
		};
	};
};
class CfgVehicles
{
	...
	class A3FL_BMW_M6: Car_F
	{
		scope = 2;
		model="\A3FL_Cars\A3FL_BMW_M6\A3FL_BMW_M6";
		picture="";
		Icon="";
		...
		class Sounds
		{
			...
			class Idle_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\Idle.ogg",
					"db-13",
					1,
					150
				};
			...
			class Engine
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\1000.ogg",
					"db-11",
					1,
					200
				};
			...
			class Engine1_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\2000.ogg",
					"db-9",
					1,
					240
				};
			...
			class Engine2_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\3000.ogg",
					"db-8",
					1,
					280
				};
			...
			class Engine3_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\4000.ogg",
					"db-7",
					1,
					320
				};
			...
			class Engine4_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\5000.ogg",
					"db-6",
					1,
					360
				};
			...
			class Engine5_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\6000.ogg",
					"db-5",
					1,
					420
				};
			...
			class Engine6_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\7000.ogg",
					"db-13",
					1,
					150
				};
			...
			class Engine7_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\8000.ogg",
					"db-11",
					1,
					200
				};
			...
			class Engine8_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\9000.ogg",
					"db-9",
					1,
					240
				};
			...
			class Engine9_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\10000.ogg",
					"db-8",
					1,
					280
				};
			...
			class Engine10_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\11000.ogg",
					"db-7",
					1,
					320
				};
			...
			class Engine11_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\12000.ogg",
					"db-6",
					1,
					360
				};
			...
			class Engine12_ext
			{
				sound[]=
				{
					"\A3FL_Cars\A3FL_BMW_M6\Sounds\13000.ogg",
					"db-5",
					1,
					420
				};
	...
	class A3FL_BMW_M6_Tuned: A3FL_BMW_M6 {
		displayName="BMW M6 Tuned";
		model="\A3FL_Cars\A3FL_BMW_M6\A3FL_BMW_M6_Tuned";
		maxSpeed=255;
		enginePower=530;
		peakTorque=650;
		class AnimationSources: AnimationSources {
			class DIffuser_S: Stock_Bonnet
			{
				initPhase=1;
				displayName="DIffuser S";
				forceAnimate[]={};
			};
			class Side_Skirt_S: Stock_Bonnet
			{
				initPhase=1;
				displayName="Side Skirt S";
				forceAnimate[]=
				{
					"Side_Skirt_SW",
					0
			...
			class Splitter_S: Stock_Bonnet
			{
				initPhase=1;
				displayName="Splitter S";
				forceAnimate[]=
				{
					"Splitter_SW",
					0
			...
			class Spoiler_S: Stock_Bonnet
			{
				initPhase=1;
				displayName="Spoiler S";
				forceAnimate[]=
				{
					"Split_Wing",
					0,
			...
			class Split_Wing: Stock_Bonnet
			{
				initPhase=0;
				displayName="Split Wing";
				forceAnimate[]=
				{
					"Spoiler_S",
					0,
			...
			class Front_Canards_SW: Stock_Bonnet
			{
				initPhase=0;
				displayName="Front Canards SW";
				forceAnimate[]={};
			};
			class Rear_Canards_SW: Stock_Bonnet
			{
				initPhase=0;
				displayName="Rear Canards SW";
				forceAnimate[]={};
			};
			class Side_Skirt_SW: Stock_Bonnet
			{
				initPhase=0;
				displayName="Side Skirt SW";
				forceAnimate[]=
				{
					"Side_Skirt_S",
					0
			...
			class Splitter_SW: Stock_Bonnet
			{
				initPhase=0;
				displayName="Splitter SW";
				forceAnimate[]=
				{
					"Splitter_S",
					0
			...
			class Spoiler_SW: Stock_Bonnet
			{
				initPhase=0;
				displayName="Spoiler SW";
				forceAnimate[]=
				{
					"Spoiler_S",
					0,
			...
			class Hoodvent: Stock_Bonnet
			{
				initPhase=0;
				displayName="Hoodvent";
				forceAnimate[]=
				{
					"Stock_Bonnet",
					0

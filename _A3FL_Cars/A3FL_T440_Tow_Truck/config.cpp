...
class CfgVehicles
{
	...
	class A3FL_T440_Tow_Truck: A3PL_Prime_Mover_Base
	{
		...
		displayName="Kenworth T440 Tow Truck";
		class Library
		{
			libTextDesc="Kenworth T440 Tow Truck";
		};
		fuelCapacity=45;
		transportSoldier=1;
		differentialType="rear_open";
		model="\A3FL_Cars\A3FL_T440_Tow_Truck\A3FL_T440_Tow_Truck";
